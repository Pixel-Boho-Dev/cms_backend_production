...
from .views import (OfficeListCreateView, OfficeRetrieveUpdateDestroyView,
                    ...
                    Location_pageRetrieveUpdateDestroyView,LocationMetaListView,LocationMetaRetrieveUpdateView,Office_locationListCreateView,Office_locationRetrieveUpdateDestroyView)
