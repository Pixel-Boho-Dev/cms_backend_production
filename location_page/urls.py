...
from .views import (OfficeListCreateView, OfficeRetrieveUpdateDestroyView,
                    ...
                    Location_pageRetrieveUpdateDestroyView,LocationMetaListView,LocationMetaRetrieveUpdateView,Office_locationListCreateView,Office_locationRetrieveUpdateDestroyView,Location_pageListView)
...
urlpatterns = [
    ...
    path('header/locationpage/', Location_pageListView.as_view(), name='location-list'),
